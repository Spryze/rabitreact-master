import { useDebounce, usePrevious } from '@rabit/hooks';
...
function RabitSettings(props) {
  const dispatch = useDispatch();
  const user = useSelector(selectUser);
  const themes = useSelector(selectRabitThemesSettings);
    ...
    (_formConfigs, prefix) =>
      Object.entries(_formConfigs).map(([key, formControl]) => {
        ...
        switch (formControl.type) {
          case 'radio': {
            return (
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <FormControl component="fieldset" className="RabitSettings-formControl">
          ...
          case 'number': {
            return (
              <div key={target} className="RabitSettings-formControl">
                <Controller
                  name={target}
                  control={control}
                  render={({ field }) => (
          ...
          case 'group': {
            return (
              <div key={target} className="RabitSettings-formGroup">
                <Typography className="RabitSettings-formGroupTitle" color="text.secondary">
                  {formControl.title}
                </Typography>
  ...
  return (
    <Root>
      <div className="RabitSettings-formGroup">
        <Typography className="RabitSettings-formGroupTitle" color="text.secondary">
          Layout
        </Typography>
        ...
        <Controller
          ...
          render={({ field }) => (
            <FormControl component="fieldset" className="RabitSettings-formControl">
              ...
              <RadioGroup {...field} aria-label="Layout Style" className="RabitSettings-group">
      ...
      <div className="RabitSettings-formGroup pb-16">
        <Typography className="RabitSettings-formGroupTitle" color="text.secondary">
          Theme
        </Typography>
      ...
      <Controller
        ...
        render={({ field }) => (
          <FormControl component="fieldset" className="RabitSettings-formControl">
            ...
            <RadioGroup {...field} aria-label="Layout Direction" className="RabitSettings-group" row>
...
export default memo(RabitSettings);
