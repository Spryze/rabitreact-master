...
function RabitHighlight(props) {
  ...
  return useMemo(() => {
    const trimCode = () => {
      ...
      // can be formatted properly while using rabit-highlight
      // component
...
RabitHighlight.propTypes = {
  component: PropTypes.node,
};
RabitHighlight.defaultProps = {
  component: 'code',
};

export default styled(RabitHighlight)``;
