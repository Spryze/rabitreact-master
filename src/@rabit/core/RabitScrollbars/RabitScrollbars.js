...
const RabitScrollbars = forwardRef((props, ref) => {
  ref = ref || createRef();
...
function mapStateToProps({ rabit }) {
  return {
    customScrollbars: rabit.settings.current.customScrollbars,
  };
}

RabitScrollbars.propTypes = {
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(
  withRouterAndRef(RabitScrollbars)
);
