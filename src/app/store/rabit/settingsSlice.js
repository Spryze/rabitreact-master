...
export const setDefaultSettings = createAsyncThunk(
  'rabit/settings/setDefaultSettings',
...
const getDirection = (state) => state.rabit.settings.current.direction;
const getMainTheme = (state) => state.rabit.settings.current.theme.main;
const getNavbarTheme = (state) => state.rabit.settings.current.theme.navbar;
const getToolbarTheme = (state) => state.rabit.settings.current.theme.toolbar;
const getFooterTheme = (state) => state.rabit.settings.current.theme.footer;
...
export const selectRabitCurrentSettings = ({ rabit }) => rabit.settings.current;

export const selectRabitCurrentLayoutConfig = ({ rabit }) => rabit.settings.current.layout.config;

export const selectRabitDefaultSettings = ({ rabit }) => rabit.settings.defaults;

export const selectRabitThemesSettings = ({ rabit }) => rabit.settings.themes;
