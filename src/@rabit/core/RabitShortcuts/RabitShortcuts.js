      ...
      <Link to={item.url || ''} role="button">
        <MenuItem key={item.id}>
          <ListItemIcon className="min-w-40">
            {item.icon ? (
              <RabitSvgIcon>{item.icon}</RabitSvgIcon>
            ) : (
          ...
          >
                ...
                _item && (
                  <Link to={_item.url} key={_item.id} role="button">
                    ...
                    >
                      ...
                      >
                        {_item.icon ? (
                          <RabitSvgIcon>{_item.icon}</RabitSvgIcon>
                        ) : (
            ...
            >
              <IconButton
                ...
                size="large"
              >
                <RabitSvgIcon sx={{ color: amber[600] }}>heroicons-solid:star</RabitSvgIcon>
              </IconButton>
            </Tooltip>
          </motion.div>
        );
...
RabitShortcuts.propTypes = {};
RabitShortcuts.defaultProps = {
  variant: 'horizontal',
};

export default memo(RabitShortcuts);
