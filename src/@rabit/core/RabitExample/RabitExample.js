import RabitHighlight from '@rabit/core/RabitHighlight';
        ...
        >
          {Component && (
            <Tab
              ...
              icon={<RabitSvgIcon>heroicons-outline:eye</RabitSvgIcon>}
            />
          )}
          {raw && (
            <Tab
              classes={{ root: 'min-w-64' }}
              icon={<RabitSvgIcon>heroicons-outline:code</RabitSvgIcon>}
            />
          )}
        </Tabs>
      </Box>
...
RabitExample.propTypes = propTypes;
RabitExample.defaultProps = defaultProps;

export default RabitExample;
