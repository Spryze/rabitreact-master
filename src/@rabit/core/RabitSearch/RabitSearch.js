...
const Root = styled('div')(({ theme }) => ({
  '& .RabitSearch-container': {
    position: 'relative',
  },

  '& .RabitSearch-suggestionsContainerOpen': {
    position: 'absolute',
    zIndex: 1,
  ...
  '& .RabitSearch-suggestion': {
    display: 'block',
  },

  '& .RabitSearch-suggestionsList': {
    margin: 0,
    padding: 0,
    listStyleType: 'none',
  },
      ...
      {variant === 'basic' ? (
        ...
        <>
          <TextField
            ...
            InputProps={{
              ...
              classes: {
                input: 'RabitSearch-input py-0 px-16 h-40 md:h-48 ltr:pr-48 rtl:pl-48',
        ...
        <TextField
          ...
          InputProps={{
            ...
            classes: {
              input: 'RabitSearch-input py-0 px-16 h-48 md:h-64',
            },
          }}
          variant="standard"
          {...other}
  ...
  return (
    <MenuItem selected={isHighlighted} component="div">
      <ListItemIcon className="min-w-40">
        {suggestion.icon ? (
          <RabitSvgIcon>{suggestion.icon}</RabitSvgIcon>
        ) : (
        ...
        <div className={clsx('flex items-center w-full', props.className)} ref={popperNode}>
          <Autosuggest
            ...
            theme={{
              ...
              suggestionsList: 'RabitSearch-suggestionsList',
              suggestion: 'RabitSearch-suggestion',
            }}
...
RabitSearch.propTypes = {};
RabitSearch.defaultProps = {
  navigation: [],
  trigger: (
    <IconButton className="w-40 h-40" size="large">
      <RabitSvgIcon>heroicons-outline:search</RabitSvgIcon>
    </IconButton>
  ),
  variant: 'full',
  placeholder: 'Search',
...
export default withRouter(memo(RabitSearch));
